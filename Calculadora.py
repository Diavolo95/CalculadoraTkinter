from tkinter import * #importante para la libreria Tkinter

ventana = Tk() #inicia el codigo
ventana.title("Calculadora") #titulo

i=0 #variable global

#entrada
e_texto=Entry(ventana,font=("Calibri 20"))#fuente y tamaño de la fuente
e_texto.grid(row=0,column=0,columnspan=4, padx=5,pady=5)#maneja el tamaño de los recuadros
#funciones
def click_boton(valor):   #añadir valores en la calculadora
    global i
    e_texto.insert(i,valor)
    i+=1 #aumenta el valor
def borrar():   #variable para borrar los elementos
    e_texto.delete(0,END)
    i=0
def ecuaciones():   #variable para realizar las ecuaciones
...
#botones de apliacion matematica(borrar,parentesis...)
...
#botones para las ecuaciones (suma,resta...)
...
boton_igual=Button(ventana,text="=",width=5,height=2,command = lambda:ecuaciones())
...
ventana.mainloop() #ventana del codigo (crea un loop)
